...
import OnboardingModal from "@/components/onboarding-model";
...
const ExplorePage = () => {
  ...
  const [showUpgradModal, setShowUpgradModal] = useState(true)
  ...
  return <>
    <div className="pb-12 text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-4">Discore Events</h1>
